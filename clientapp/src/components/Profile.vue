					...
					<div class="card-body">
						<nav class="nav flex-column nav-pills nav-gap-y-1">
							...
							<router-link to="/settings" tag="li">
								<a data-toggle="tab" class="nav-item nav-link has-icon nav-link-faded">
							...
							<router-link to="/chancgepassword">
						...
						<div class="tab-pane active" id="profile">
							...
							<form>
								<div class="form-group">
									...
									<input type="text" class="form-control" id="fullName" aria-describedby="fullNameHelp" placeholder="Enter your fullname" value="test@gmail.com">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="url" placeholder="Enter your website address" value="https://vuejs.org/">
								</div>
								<div class="form-group">
